...
Definir el modelo inicial de base de datos para SIGCAL.
...
| Bucket | Uso |
|---|---|
| `calibration-certificates` | Certificados de calibración |
| `remission-guides` | Guías de remisión |
| `tool-images` | Fotos de herramientas/equipos |
| `support-documents` | Documentos complementarios |
...
## Política inicial sugerida para usuarios autenticados
...
En fases posteriores se deben crear roles más finos:
